...
use App\Http\Livewire\Auth\DegreeLogin;
...
use App\Http\Livewire\Auth\DegreeRegister;
...
use App\Http\Livewire\Applications\SearchUtme;
...
use App\Http\Livewire\Transactions\PostUtmeInvoice;
...
Route::middleware(['auth', 'verified', 'role:applicant'])->group(function () {
    ...
    Route::get('applications/search-utme', SearchUtme::class)->name('search-utme');
