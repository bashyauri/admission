...
return [
    ...
    'settings' => [
        ...
        'admin_academic_session' => env('ADMIN_ACADEMIC_SESSION'),
        'hod_academic_session'   => env('HOD_ACADEMIC_SESSION'),
        'ug_applicant_session'   => env('UG_APPLICANT_SESSION'),
        'pg_applicant_session'   => env('PG_APPLICANT_SESSION'),
