                    ...
                    <div class="mt-4 row">
                        <div class="col-12 col-lg-10 offset-lg-1">
                          ...
                          <form action="https://login.remita.net/remita/ecomm/finalize.reg" name="SubmitRemitaForm" method="POST">
                            ...
                            <input name="hash" value="{{$studenttransaction->apiHash}}" type="hidden">

                            <input name="rrr" value="{{$studenttransaction->RRR}}" type="hidden">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div>
                                            ...
                                            <span
                                                ...
                                                {{ $studenttransaction->user->full_name }}</span>
                                        </div>
                                        <div class="text-grey-m2">
                                            <div class="my-1">
                                                <i class="fas fa-envelope"></i>
                                                <b class="text-600">{{ $studenttransaction->user->email }}</b>
                                            </div>

                                            <div class="my-1"><i class="fas fa-phone"></i> <b
                                                    class="text-600">{{ $studenttransaction->user->phone }}</b></div>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                    ...
                                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                        ...
                                        <div class="text-grey-m2">
                                            ...
                                            @endphp
                                                @if ($studenttransaction->status === $approved->toString())
                                                Reciept
                                            @else
                                            Invoice
                                            @endif
                                            ...
                                            <div class="my-2"><i
                                                    ...
                                                    class="text-600 text-90">ID:</span> #{{ $studenttransaction->transaction_id }}</div>

                                            <div class="my-2"><i
                                                    class="mr-1 text-xs fa fa-circle text-blue-m2"></i> <span
                                                    class="text-600 text-90">Issue Date:{{$studenttransaction->date}}</span>
                                            </div>

                                            <div class="my-2"><i
                                                    class="mr-1 text-xs fa fa-circle text-blue-m2"></i> <span
                                                    class="text-600 text-90">Status:{{$studenttransaction->status}}</span>
                                                @if ($studenttransaction->status === $approved->toString())
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="text-95 text-secondary-d3">
                                        <div class="mb-2 row mb-sm-0 py-25">
                                            ...
                                            <div class="col-md-6 col-sm-5">{{ $studenttransaction->resource }}</div>

                                            <div class="d-none d-sm-block col-2 text-95">{{ $studenttransaction->RRR }}</div>
                                            <div class="col-2 text-secondary-d2">{{ $studenttransaction->phone }}</div>
                                            <div class="col-2 text-secondary-d2">{{ $studenttransaction->amount }}</div>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="order-first col-12 col-sm-5 text-grey text-90 order-sm-last">
                                                <div class="my-2 row">
                                                    ...
                                                    <div class="col-5">
                                                        <span class="text-120 text-secondary-d1">&#8358
                                                            {{ $studenttransaction->amount }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    @if ($studenttransaction->status === $activated->toString() || $studenttransaction->status === $approved->toString())
