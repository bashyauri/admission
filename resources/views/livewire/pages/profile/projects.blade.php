            ...
            <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex">
                            <div
                                class="w-19 h-19 text-size-base ease-soft-in-out bg-gradient-dark-gray dark:bg-gradient-neutral inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                <img class="w-full" src="../../../assets/img/small-logos/logo-slack.svg"
                            ...
                            <div class="ml-auto">
                                <div class="relative">
                                    <button dropdown-trigger
                                        class="inline-block py-3 pl-0 pr-2 mb-4 font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 text-slate-400 dark:text-white"
                                        aria-expanded="false">
                                        <i class="fa fa-ellipsis-v text-size-lg" aria-hidden="true"></i>
                                    </button>
                                    <p class="hidden transform-dropdown-show"></p>
                                    <div dropdown-menu
                                        class="dark:shadow-soft-dark-xl z-100 dark:bg-gray-950 text-size-sm lg:shadow-soft-3xl duration-250 before:duration-350 before:font-awesome before:ease-soft min-w-44 before:text-5.5 transform-dropdown pointer-events-none absolute right-0 left-auto top-0 m-0 -mr-4 mt-2 list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-0 py-2 text-left text-slate-500 opacity-0 transition-all before:absolute before:top-0 before:right-7 before:left-auto before:z-40 before:text-white before:transition-all before:content-['\f0d8'] sm:-mr-6">
                        ...
                        <p class="mt-4 leading-normal text-size-sm">If everything I did failed - which it doesn't, I
                            think that it actually succeeds.</p>
                        <hr
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">5</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">
                                    Participants
                                </p>
                            </div>
                            <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">02.03.22</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">Due date
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex">
                            <div
                                class="w-19 h-19 text-size-base ease-soft-in-out bg-gradient-dark-gray dark:bg-gradient-neutral inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                <img class="w-full" src="../../../assets/img/small-logos/logo-spotify.svg"
                                    alt="Image placeholder" />
                            </div>
                            <div class="my-auto ml-4">
                        ...
                        <p class="mt-4 leading-normal text-size-sm">Pink is obviously a better color. Everyone’s
                            born
                            confident, and everything’s taken away from you.</p>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">3</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">
                                    Participants
                                </p>
                            </div>
                            <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">22.11.21</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">Due date
                                </p>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex">
                            <div
                                class="w-19 h-19 text-size-base ease-soft-in-out bg-gradient-dark-gray dark:bg-gradient-neutral inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                <img class="w-full" src="../../../assets/img/small-logos/logo-xd.svg"
                                    alt="Image placeholder" />
                            </div>
                            <div class="my-auto ml-4">
                        ...
                        <p class="mt-4 leading-normal text-size-sm">Constantly growing. We’re constantly making
                            mistakes
                            from which we learn and improve.</p>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">4</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">
                                    Participants
                                </p>
                            </div>
                            <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">06.03.22</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">Due date
                                </p>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex">
                            <div
                                class="w-19 h-19 text-size-base ease-soft-in-out bg-gradient-dark-gray dark:bg-gradient-neutral inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                <img class="w-full" src="../../../assets/img/small-logos/logo-asana.svg"
                                    alt="Image placeholder" />
                            </div>
                            <div class="my-auto ml-4">
                        ...
                        <p class="mt-4 leading-normal text-size-sm">You have the opportunity to play this game of
                            life
                            you need to appreciate every moment.</p>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">6</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">
                                    Participants
                                </p>
                            </div>
                            <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">14.03.24</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">Due date
                                </p>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex">
                            <div
                                class="w-19 h-19 text-size-base ease-soft-in-out bg-gradient-dark-gray dark:bg-gradient-neutral inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                <img class="w-full" src="../../../assets/img/small-logos/logo-invision.svg"
                                    alt="Image placeholder" />
                            </div>
                            <div class="my-auto ml-4">
                        ...
                        <p class="mt-4 leading-normal text-size-sm">For standing out. But the time is now to be okay
                            to
                            be the greatest you.</p>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                            ...
                            <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                <h6 class="mb-0 leading-normal text-size-sm">16.01.22</h6>
                                <p class="mb-0 font-semibold leading-normal text-size-sm text-slate-400">Due date
                                </p>
                            </div>
                        </div>
