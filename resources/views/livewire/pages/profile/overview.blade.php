<div>
    <div
        class="min-h-75 relative flex items-center overflow-hidden rounded-2xl bg-[url('../../assets/img/curved-images/curved0.jpg')] bg-cover bg-center p-0">
    ...
    <div
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-auto max-w-full px-3">
                <div
                    class="text-size-base ease-soft-in-out h-19 w-19 relative inline-flex items-center justify-center rounded-xl text-white transition-all duration-200">
            ...
            <div class="flex-none w-auto max-w-full px-3 my-auto">
                <div class="h-full">
                    ...
                    <p class="mb-0 font-semibold leading-normal text-size-sm dark:text-white dark:opacity-60">CEO /
                        Co-Founder</p>
                </div>
            </div>
                ...
                <div class="relative right-0">
                    <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl" nav-pills role="list">
                        <li class="z-30 flex-auto text-center">
                            <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700 dark:text-white"
                                        ...
                                        <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF"
                                            ...
                                            <g transform="translate(1716.000000, 291.000000)">
                                                <g transform="translate(603.000000, 0.000000)">
                                                    <path class="fill-slate-800 dark:fill-white"
                                        ...
                                        <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF"
                                            ...
                                            <g transform="translate(1716.000000, 291.000000)">
                                                <g transform="translate(304.000000, 151.000000)">
                                                    <polygon class="fill-slate-800 dark:fill-white"
                                                        opacity="0.596981957"
        ...
        <div class="flex flex-wrap -mx-3">
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li class="relative block px-0 py-2 border-0 rounded-t-lg text-inherit">
                                <div class="min-h-6 mb-0.5 block pl-0">
                                    <input
                                        class="mt-0.5 rounded-10 duration-250 ease-soft-in-out after:rounded-circle after:shadow-soft-2xl after:duration-250 checked:after:translate-x-5.3 h-5-em relative float-left ml-auto w-10 cursor-pointer appearance-none border border-solid border-gray-200 bg-slate-800/10 bg-none bg-contain bg-left bg-no-repeat align-top transition-all after:absolute after:top-px after:h-4 after:w-4 after:translate-x-px after:bg-white after:content-[''] checked:border-slate-800/95 checked:bg-slate-800/95 checked:bg-none checked:bg-right"
                                        type="checkbox" " checked />
                      <label class=" w-4/5 mb-0 ml-4 overflow-hidden font-normal cursor-pointer text-size-sm
                            ...
                            <li class="relative block px-0 py-2 border-0 text-inherit">
                                <div class="min-h-6 mb-0.5 block pl-0">
                                    <input
                                        ...
                                        type="checkbox" />
                                    <label
                                        class="w-4/5 mb-0 ml-4 overflow-hidden font-normal cursor-pointer text-size-sm text-ellipsis whitespace-nowrap text-slate-500 dark:text-white/80"
            ...
            <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
                <div
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="w-full max-w-full px-3 text-right shrink-0 md:w-4/12 md:flex-none">
                                <a href="javascript:;" data-target="tooltip_trigger">
                                    <i
                                        class="leading-normal fas fa-user-edit text-size-sm text-slate-400 dark:text-white dark:opacity-80"></i>
                                </a>
                                <div class="hidden px-2 py-1 text-center text-white bg-black rounded-lg text-size-sm"
                    ...
                    <div class="flex-auto p-4">
                        <p class="leading-normal text-size-sm dark:text-white dark:opacity-60">Hi, I’m Alec Thompson,
                            Decisions: If you can’t decide, the answer is no. If two equally difficult paths, choose the
                            one
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li
                                class="relative block px-4 py-2 pt-0 pl-0 leading-normal border-0 rounded-t-lg text-size-sm text-inherit">
                                <strong class="text-slate-700 dark:text-white">Full Name:</strong> &nbsp; Alec M.
                                Thompson
                            </li>
                            <li
                                class="relative block px-4 py-2 pl-0 leading-normal border-0 border-t-0 text-size-sm text-inherit">
                                <strong class="text-slate-700 dark:text-white">Mobile:</strong> &nbsp; (44) 123 1234 123
                            </li>
                            <li
                                class="relative block px-4 py-2 pl-0 leading-normal border-0 border-t-0 text-size-sm text-inherit">
                                <strong class="text-slate-700 dark:text-white">Email:</strong> &nbsp;
                                alecthompson@mail.com
                            </li>
                            <li
                                class="relative block px-4 py-2 pl-0 leading-normal border-0 border-t-0 text-size-sm text-inherit">
                                <strong class="text-slate-700 dark:text-white">Location:</strong> &nbsp; USA
                            </li>
                            <li
                                class="relative block px-4 py-2 pb-0 pl-0 border-0 border-t-0 rounded-b-lg text-inherit">
                                <strong
                                    class="leading-normal text-size-sm text-slate-700 dark:text-white">Social:</strong>
                                &nbsp;
            ...
            <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
                <div
                    class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="p-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
                        <h6 class="mb-0 dark:text-white">Conversations</h6>
                    </div>
                    <div class="flex-auto p-4">
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li class="relative flex items-center px-0 py-2 mb-2 border-0 rounded-t-lg text-inherit">
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Sophie B.</h6>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white dark:opacity-60">Hi! I
                                        need
                                        more information..</p>
                                </div>
                            ...
                            <li class="relative flex items-center px-0 py-2 mb-2 border-0 border-t-0 text-inherit">
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Anne Marie</h6>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white dark:opacity-60">Awesome
                                        work,
                                        can you..</p>
                                </div>
                                <a class="inline-block py-3 pl-0 pr-4 mb-0 ml-auto font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-size-xs ease-soft-in hover:scale-102 hover:active:scale-102 active:opacity-85 text-fuchsia-500 hover:text-fuchsia-800 hover:shadow-none active:scale-100"
                            ...
                            <li class="relative flex items-center px-0 py-2 mb-2 border-0 border-t-0 text-inherit">
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Ivanna</h6>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white dark:opacity-60">About
                                        files I
                                        can..</p>
                                </div>
                                <a class="inline-block py-3 pl-0 pr-4 mb-0 ml-auto font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-size-xs ease-soft-in hover:scale-102 hover:active:scale-102 active:opacity-85 text-fuchsia-500 hover:text-fuchsia-800 hover:shadow-none active:scale-100"
                            ...
                            <li class="relative flex items-center px-0 py-2 mb-2 border-0 border-t-0 text-inherit">
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Peterson</h6>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white dark:opacity-60">Have a
                                        great
                                        afternoon..</p>
                                </div>
                                <a class="inline-block py-3 pl-0 pr-4 mb-0 ml-auto font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-size-xs ease-soft-in hover:scale-102 hover:active:scale-102 active:opacity-85 text-fuchsia-500 hover:text-fuchsia-800 hover:shadow-none active:scale-100"
                            ...
                            <li
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Nick Daniel</h6>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white dark:opacity-60">Hi! I
                                        need
                                        more information..</p>
                                </div>
            ...
            <div class="flex-none w-full max-w-full px-3 mt-6">
                <div
                    ...
                    <div class="p-4 pb-0 mb-0 rounded-t-2xl">
                        ...
                        <p class="leading-normal text-size-sm dark:text-white dark:opacity-80">Architects design houses
                        </p>
                    </div>
                    <div class="flex-auto p-4">
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                <div
                                    class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                                    <div class="relative">
                                    ...
                                    <div class="flex-auto px-1 pt-6">
                                        <p
                                            class="relative z-10 mb-2 leading-normal text-transparent bg-gradient-dark-gray text-size-sm bg-clip-text dark:text-white dark:opacity-80">
                                            Project #2</p>
                                        <a href="javascript:;">
                                            <h5 class="dark:text-white">Modern</h5>
                                        </a>
                                        <p class="mb-6 leading-normal text-size-sm dark:text-white dark:opacity-60">As
                                            Uber
                                            works through a huge amount of internal management turmoil.</p>
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="hidden px-2 py-1 text-white bg-black rounded-lg text-size-sm"
                                ...
                                <div
                                    ...
                                    <div class="flex-auto px-1 pt-6">
                                        <p
                                            ...
                                            Project #1</p>
                                        <a href="javascript:;">
                                            <h5 class="dark:text-white">Scandinavian</h5>
                                        </a>
                                        <p class="mb-6 leading-normal text-size-sm dark:text-white dark:opacity-60">
                                            Music is
                                ...
                                <div
                                    ...
                                    <div class="flex-auto px-1 pt-6">
                                        <p
                                            ...
                                            Project #3</p>
                                        <a href="javascript:;">
                                            <h5 class="dark:text-white">Minimalist</h5>
                                        </a>
                                        <p class="mb-6 leading-normal text-size-sm dark:text-white dark:opacity-60">
                                            Different people have different taste, and various types of music.</p>
                                        <div class="flex items-center justify-between">
                                            <button type="button"
                                                class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-size-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">View
                                                Project</button>
                            ...
                            <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                <div
                                    class="relative flex flex-col h-full min-w-0 break-words bg-transparent border border-solid shadow-none dark:shadow-soft-dark-xl rounded-2xl border-slate-100 bg-clip-border dark:border-slate-700">
                                    <div class="flex flex-col justify-center flex-auto p-6 text-center">
                                        <a href="javascript:;">
                                            <i
                                                class="mb-4 fa fa-plus text-slate-400 dark:text-white dark:opacity-80"></i>
                                            <h5 class="text-slate-400 dark:text-white dark:opacity-80">New project</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
