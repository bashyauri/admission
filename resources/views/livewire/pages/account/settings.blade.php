                    ...
                    <ul class="flex flex-col flex-wrap p-4 mb-0 list-none rounded-xl">
                        ...
                        <li class="pt-2">
                            <a href="#password"
                                class="block px-4 py-2 transition-colors rounded-lg ease-soft-in-out text-slate-500 hover:bg-gray-200">
                                <div class="inline-block mr-2 text-black fill-current h-4-em w-4-em stroke-none">
                                    <svg class="mb-1 text-dark" width="16px" height="16px" viewBox="0 0 42 42"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <span class="leading-normal text-size-sm dark:text-white">Change Password</span>
                            </a>
                        </li>
                        <li class="pt-2">
                            <a href="#2FA"
                        ...
                        <li class="pt-2">
                            <a href="#notifications"
                                ...
                                <span class="leading-normal text-size-sm dark:text-white">Notifications</span>
                            </a>
                        </li>
                        <li class="pt-2">
                            <a href="#sessions"
                        ...
                        <li class="pt-2">
                            <a href="#delete"
                                class="block px-4 py-2 transition-colors rounded-lg ease-soft-in-out text-slate-500 hover:bg-gray-200">
                                <div class="inline-block mr-2 text-black fill-current h-4-em w-4-em stroke-none">
                                    <svg class="mb-1 text-dark" width="16px" height="16px" viewBox="0 0 45 40"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <title>shop</title>
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="leading-normal text-size-sm dark:text-white">Delete Account</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 lg:w-9/12">
                    ...
                    <div class="flex flex-wrap items-center justify-center -mx-3">
                        <div class="w-4/12 max-w-full px-3 flex-0 sm:w-auto">
                            <div
                                ...
                                <img class="w-full shadow-soft-sm rounded-xl" src="../../../assets/img/bruce-mars.jpg"
                                    alt="bruce" />
                            </div>
                        </div>
                        <div class="w-8/12 max-w-full px-3 my-auto flex-0 sm:w-auto">
                            <div class="h-full">
                                <h5 class="mb-1 font-bold dark:text-white">Alec Thompson</h5>
                            ...
                            <div class="w-full max-w-full px-3 sm:flex-0 shrink-0 sm:w-8/12">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-5/12 max-w-full px-3 flex-0">
                                        <label
                                            class="mt-6 mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                ...
                <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border"
                    ...
                    <div class="flex p-6 rounded-t-2xl">
                        ...
                        <span
                            class="py-2.2-em px-3.6-em text-size-xs-em rounded-1.8 ml-auto inline-block whitespace-nowrap bg-lime-200 text-center align-baseline font-bold uppercase leading-none text-lime-600">Enabled</span>
                    </div>
                    <div class="flex-auto p-6">
                        <div class="flex">
                            ...
                            <p
                                ...
                                No Security Keys</p>
                            <button
                                class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer active:opacity-85 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:scale-102 active:shadow-soft-xs border-slate-700 text-slate-700 hover:text-slate-700 hover:opacity-75 hover:shadow-none active:scale-100 active:border-slate-700 active:bg-slate-700 active:text-white hover:active:border-slate-700 hover:active:text-slate-700 hover:active:opacity-75">Add</button>
                        </div>
                        <hr
                        ...
                        <div class="flex">
                            ...
                            <p
                                ...
                                +4012374423</p>
                            <button
                                class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer active:opacity-85 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:scale-102 active:shadow-soft-xs border-slate-700 text-slate-700 hover:text-slate-700 hover:opacity-75 hover:shadow-none active:scale-100 active:border-slate-700 active:bg-slate-700 active:text-white hover:active:border-slate-700 hover:active:text-slate-700 hover:active:opacity-75">Edit</button>
                        </div>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        <div class="flex">
                ...
                <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border"
                    ...
                    <div class="p-6 rounded-t-2xl">
                        ...
                        <p class="leading-normal text-size-sm dark:text-white/60">Here you can setup and manage your
                    ...
                    <div class="flex-auto p-6 pt-0">
                        <div class="flex">
                            ...
                            <div class="my-auto ml-4">
                                <div class="h-full">
                                    ...
                                    <a class="leading-normal text-size-sm text-slate-500 dark:text-white"
                                        href="javascript:;">
                                        Show less
                                        <i class="ml-1 leading-tight fas fa-chevron-up text-size-xs"></i>
                                    </a>
                                </div>
                            </div>
                            <p
                                class="my-auto ml-auto mr-4 leading-normal text-size-sm text-slate-400 dark:text-white/80">
                                Enabled</p>
                        ...
                        <div class="pt-4 pl-12 ml-4">
                            <p class="mb-0 leading-normal text-size-sm dark:text-white/60">
                            ...
                            <div class="p-2 my-6 rounded-xl bg-gray-50 dark:bg-gray-600 sm:flex">
                                <p class="my-auto font-semibold leading-normal text-size-sm sm:pl-2">Verification Code
                                </p>
                                <input
                                    class="min-h-unset sm:w-15/100 text-size-xs focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 leading-5.6 ease-soft mt-2 block w-2/5 appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-1 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none sm:mt-0 sm:ml-auto"
                                    type="text" name="code" value="1172913" data-target="tooltip_trigger" />
                                <div class="hidden px-2 py-1 text-white bg-black rounded-lg text-size-sm" id="tooltip"
                            ...
                            <div class="p-2 my-6 rounded-xl bg-gray-50 dark:bg-gray-600 sm:flex">
                                <p class="my-auto font-semibold leading-normal text-size-sm sm:pl-2">Connected account
                                </p>
                                <h6 class="my-auto ml-auto mr-4 leading-normal text-size-sm dark:text-white">
                                    hello@creative-tim.com</h6>
                                <button type="button"
                                    class="inline-block px-8 py-2 m-0 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer tracking-tight-soft ease-soft-in leading-pro bg-gradient-red shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">Delete</button>
                            </div>
                        </div>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        ...
                        <div class="flex">
                            ...
                            <div class="my-auto ml-4">
                                <div class="h-full">
                                    ...
                                    <p class="mb-0 leading-normal text-size-sm dark:text-white/60">Music</p>
                                </div>
                            </div>
                            <p
                                class="my-auto ml-auto mr-4 leading-normal text-size-sm text-slate-400 dark:text-white/80">
                        ...
                        <div class="flex">
                            ...
                            <div class="my-auto ml-4">
                                <div class="h-full">
                                    ...
                                    <p class="mb-0 leading-normal text-size-sm dark:text-white/60">Payment vendor</p>
                                </div>
                            </div>
                            <p
                                class="my-auto ml-auto mr-4 leading-normal text-size-sm text-slate-400 dark:text-white/80">
                        ...
                        <div class="flex">
                            ...
                            <div class="my-auto ml-4">
                                <div class="h-full">
                                    ...
                                    <p class="mb-0 leading-normal text-size-sm dark:text-white/60">Organize your team
                                    </p>
                                </div>
                            </div>
                ...
                <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border"
                    ...
                    <div class="p-6 pb-4 rounded-t-2xl">
                        ...
                        <p class="leading-normal text-size-sm dark:text-white/60">This is a list of devices that have
                            logged into your account. Remove those that you do not recognize.</p>
                    </div>
                    <div class="flex-auto p-6 pt-0">
                        <div class="flex items-center">
                            <div class="text-center w-5/100">
                                <i class="fas fa-desktop text-size-lg opacity-60"></i>
                            </div>
                            <div class="my-auto ml-4">
                                <div class="h-full">
                                    <p class="mb-1 leading-normal text-size-sm dark:text-white/60">Bucharest
                                        68.133.163.201</p>
                                    <p class="mb-0 leading-tight text-size-xs dark:text-white/60">Your current session
                                    </p>
                                </div>
                            </div>
                            <span
                                class="py-1.8-em text-size-xxs-em px-3-em rounded-1 my-auto ml-auto mr-4 inline-block whitespace-nowrap bg-lime-200 text-center align-baseline font-bold uppercase leading-none text-lime-600">Active</span>
                            <p
                                class="my-auto mr-4 leading-normal text-size-sm text-slate-400 dark:text-white dark:opacity-80">
                                EU</p>
                            <a href="javascript:;" class="my-auto leading-normal text-size-sm group text-fuchsia-500">
                                See more
                                <i
                                    class="group-hover:translate-x-1.25 fas fa-arrow-right text-size-xs ease-bounce ml-1 leading-tight transition-all duration-200"></i>
                            </a>
                        </div>
                        <hr
                            class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-horizontal-dark dark:bg-gradient-horizontal-light" />
                        ...
                        <div class="flex items-center">
                            <div class="text-center w-5/100">
                                <i class="fas fa-mobile text-size-lg opacity-60"></i>
                            </div>
                ...
                <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border"
                    ...
                    <div class="flex-auto p-6 pt-0 sm:flex">
                        <div class="flex items-center mb-6 sm:mb-0">
                            ...
                            <div class="ml-2">
                                <span
                                    class="block font-semibold leading-normal text-size-sm text-slate-700 dark:text-white">Confirm</span>
                                <span class="block leading-tight text-size-xs">I want to delete my account.</span>
                            </div>
                        </div>
                        <button type="button"
                        ...
                        <button type="button"
                            class="inline-block px-6 py-3 m-0 ml-2 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-gradient-red shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">Delete
                            account</button>
                    </div>
                </div>
            </div>
