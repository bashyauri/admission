                        ...
                        <div
                            ...
                            <div class="relative overflow-hidden rounded-2xl"
                                ...
                                <div class="relative z-10 flex-auto p-4">
                                    ...
                                    <h5 class="pb-2 mt-6 mb-12 text-white dark:text-white">
                                        4562&nbsp;&nbsp;&nbsp;1122&nbsp;&nbsp;&nbsp;4594&nbsp;&nbsp;&nbsp;7852</h5>
                                    <div class="flex">
                                        <div class="flex">
                                            <div class="mr-6">
                                                <p class="mb-0 leading-normal text-white text-size-sm opacity-80">Card
                                                    Holder</p>
                                                <h6 class="mb-0 text-white dark:text-white">Jack Peterson</h6>
                                            </div>
                                            <div>
                                                <p class="mb-0 leading-normal text-white text-size-sm opacity-80">
                                                    Expires</p>
                            ...
                            <div class="w-full max-w-full px-3 md:w-1/2 md:flex-none">
                                <div
                                    ...
                                    <div class="flex-auto p-4 pt-0 text-center">
                                        ...
                                        <hr
                                            class="h-px my-4 bg-transparent dark:bg-gradient-horizontal-light bg-gradient-horizontal-dark" />
                            ...
                            <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="flex-none w-1/2 max-w-full px-3 text-right">
                                        <a class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-size-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-dark-gray dark:bg-gradient-neutral hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"
                ...
                <div
                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="flex-none w-1/2 max-w-full px-3 text-right">
                                <button
                                    class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointe leading-pro ease-soft-in text-size-xs bg-150 active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25 border-fuchsia-500 text-fuchsia-500 hover:opacity-75">View
                                    All</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li
                                ...
                                <div class="flex flex-col">
                                    <h6
                                        class="mb-1 font-semibold leading-normal text-size-sm text-slate-700 dark:text-white">
                                        March, 01, 2020</h6>
                                ...
                                <div class="flex items-center leading-normal text-size-sm">
                                    $180
                                    <button
                                        class="inline-block px-0 py-3 mb-0 ml-6 font-bold leading-normal text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer ease-soft-in bg-150 text-size-sm active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25 text-slate-700 dark:text-white"><i
                    ...
                    <div class="flex-auto p-4 pt-6">
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li
                                ...
                                <div class="flex flex-col">
                                    <h6 class="mb-4 leading-normal text-size-sm dark:text-white">Oliver Liam</h6>
                                ...
                                <div class="ml-auto text-right">
                                    ...
                                    <a class="inline-block px-4 py-3 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-size-xs ease-soft-in bg-150 hover:scale-102 active:opacity-85 bg-x-25 text-slate-700 dark:text-white"
                                        href="javascript:;"><i class="mr-2 fas fa-pencil-alt text-slate-700"
                                            aria-hidden="true"></i>Edit</a>
                                </div>
                            </li>
                            <li class="relative flex p-6 mt-4 mb-2 border-0 rounded-xl bg-gray-50 dark:bg-transparent">
                                <div class="flex flex-col">
                                    <h6 class="mb-4 leading-normal text-size-sm dark:text-white">Lucas Harper</h6>
                                    <span class="mb-2 leading-tight text-size-xs">Company Name: <span
                            ...
                            <li
                                ...
                                <div class="flex flex-col">
                                    <h6 class="mb-4 leading-normal text-size-sm dark:text-white">Ethan James</h6>
                                    <span class="mb-2 leading-tight text-size-xs">Company Name: <span
                    ...
                    <div class="flex-auto p-4 pt-6">
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            <li
                                ...
                                <div class="flex items-center">
                                    <button
                                        class="leading-pro ease-soft-in text-size-xs bg-150 w-6 h-6 p-1.2 rounded-3.5xl tracking-tight-soft bg-x-25 mr-4 mb-0 flex cursor-pointer items-center justify-center border border-solid border-red-600 border-transparent bg-transparent text-center align-middle font-bold uppercase text-red-600 transition-all hover:opacity-75"><i
                            ...
                            <li
                                ...
                                <div class="flex items-center">
                                    <button
                                        class="leading-pro ease-soft-in text-size-xs bg-150 w-6 h-6 p-1.2 rounded-3.5xl tracking-tight-soft bg-x-25 mr-4 mb-0 flex cursor-pointer items-center justify-center border border-solid border-lime-500 border-transparent bg-transparent text-center align-middle font-bold uppercase text-lime-500 transition-all hover:opacity-75"><i
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            ...
                            <li
                                ...
                                <div class="flex items-center">
                                    <button
                                        class="leading-pro ease-soft-in text-size-xs bg-150 w-6 h-6 p-1.2 rounded-3.5xl tracking-tight-soft bg-x-25 mr-4 mb-0 flex cursor-pointer items-center justify-center border border-solid border-slate-700 border-transparent bg-transparent text-center align-middle font-bold uppercase text-slate-700 transition-all hover:opacity-75"><i
