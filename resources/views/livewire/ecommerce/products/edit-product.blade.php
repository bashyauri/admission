<div>
    <div class="flex flex-wrap -mx-3">
        <div class="w-full max-w-full px-3 shrink-0 lg:flex-0 lg:w-6/12">
            <h4 class="dark:text-white">Make the changes below</h4>
        ...
        <div class="flex flex-col justify-center w-full max-w-full px-3 text-right shrink-0 lg:flex-0 lg:w-6/12">
            <button type="button"
                class="inline-block px-6 py-3 mt-2 mb-0 mr-auto font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer lg:ml-auto lg:mr-0 lg:mt-0 hover:scale-102 active:opacity-85 hover:shadow-soft-xs bg-gradient-fuchsia leading-pro text-size-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25">Save</button>
        </div>
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 flex-0">
                            <img class="w-full mt-4 rounded-xl shadow-soft-3xl"
                        ...
                        <div class="w-full max-w-full px-3 mt-6 flex-0">
                            <div class="flex">
                                <button type="button"
                                    class="inline-block px-8 py-2 mr-2 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-gradient-fuchsia shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">Edit</button>
                                <button type="button"
                                    class="inline-block px-8 py-2 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer active:opacity-85 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:scale-102 active:shadow-soft-xs border-slate-700 dark:border-white dark:text-white dark:hover:text-white dark:active:border-white dark:hover:active:border-white dark:active:hover:text-white text-slate-700 hover:text-slate-700 hover:opacity-75 hover:shadow-none active:scale-100 active:border-slate-700 active:bg-slate-700 active:text-white hover:active:border-slate-700 hover:active:text-slate-700 hover:active:opacity-75">Remove</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full max-w-full px-3 mt-6 shrink-0 lg:flex-0 lg:w-8/12 lg:mt-0">
            <div
                ...
                <div class="flex-auto p-6">
                    <h5 class="font-bold dark:text-white">Product Information</h5>
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                            ...
                            <input type="text" name="ProductName" value="Minimal Bar Stool"
                        ...
                        <div class="w-full max-w-full px-3 mt-4 flex-0 sm:w-6/12 sm:mt-0">
                            ...
                            <input type="number" name="Weight" value="2"
                                class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-3/12 max-w-full px-3 flex-0">
                            ...
                            <input type="text" name="Collection" value="Summer"
                                class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                        </div>
                        <div class="w-3/12 max-w-full px-3 flex-0">
                            <label class="mt-6 mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                            <label class="mt-6 mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="Description">Description<small> (optional)</small></label>
                            <div editor-quill id="editor" class="!h-1/2">
                                <p>Long sleeves black denim jacket with a twisted design. Contrast stitching. Button
                                    up closure. White arrow prints on the back.</p>
                            </div>
                        </div>
                        <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                            <label class="mt-6 mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="choices-category">Category</label>
                            <select choice name="choices-category" choices-select>
                            ...
                            <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="choices-color">Color</label>
                            <select choice name="choices-color" choices-select>
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full max-w-full px-3 shrink-0 sm:flex-0 sm:w-4/12">
            <div
                ...
                <div class="flex-auto p-6">
                    ...
                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                        for="Shoppify Handle">Shoppify Handle</label>
        ...
        <div class="w-full max-w-full px-3 mt-6 shrink-0 sm:flex-0 sm:w-8/12 sm:mt-0">
            <div
                ...
                <div class="flex-auto p-6">
                    <div class="flex flex-wrap -mx-3">
                        <h5 class="w-full max-w-full px-3 font-bold dark:text-white shrink-0">Pricing</h5>
                        <div class="w-3/12 max-w-full px-3 flex-0">
                            <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="Price">Price</label>
                            <input type="number" name="Price" value="99.00"
                                class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                        </div>
                        ...
                        <div class="w-5/12 max-w-full px-3 flex-0">
                            <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="SKU">SKU</label>
                            <input type="text" name="SKU" value="71283476591"
                                class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 flex-0">
                            <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                for="Tags">Tags</label>
                            <input choice name="Tags" id="choices-multiple-remove-button" type="text"
                                value="In Stock, Out of Stock" placeholder="Enter something" />
                        </div>
                    </div>
                </div>
            </div>
