    ...
    <div class="w-full max-w-full px-3 flex-0">
        <div
            ...
            <div class="pt-6 pr-6 pl-6 mb-0 rounded-t-2xl">
                <h5 class="dark:text-white">Tag Management</h5>
                <p class="dark:text-white"> Here you can manage tags. </p>
            ...
            <div class="my-auto ml-auto pr-6">
                <a href="{{ route('add-tag') }}"><button type="button"
                ...
                <table class="items-center w-full mb-4 align-top border-gray-200 text-slate-500 dark:border-white/40">
                    <thead class="align-bottom">
                        <tr>
                            ...
                            <th wire:click="sortBy('color')" :direction="$sortField === 'color' ? $sortDirection : null" 
                                ...
                                Color<span><i class="fas fa-sort cursor-pointer ml-1 dark:text-white/80" aria-hidden="true"></i></span>
                            </th>
                            ...
                            <td
                                ...
                                <p class="mb-0 font-semibold leading-tight text-base">
                                    ...
                                    @can('manage-items', auth()->user())
                                        @can('update', $tag)
                                            <a rel="tooltip" href="{{ route('edit-tag', $tag)}}">
