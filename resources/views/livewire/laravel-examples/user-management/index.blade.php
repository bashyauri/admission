    ...
    <div class="w-full max-w-full px-3 flex-0">
        <div
            ...
            <div class="pt-6 pr-6 pl-6 mb-0 rounded-t-2xl">
                <h5 class="dark:text-white">User Management</h5>
                <p class="dark:text-white"> Here you can manage users. </p>
            ...
            <div class="my-auto ml-auto pr-6">
                <a href="{{ route('add-user') }}"><button type="button"
                ...
                <table class="items-center w-full mb-4 align-top border-gray-200 text-slate-500 dark:border-white/40">
                    <thead class="align-bottom">
                        <tr>
                            ...
                            <th wire:click="sortBy('email')" :direction="$sortField === 'email' ? $sortDirection : null"
                                ...
                                Email<span><i class="fas fa-sort cursor-pointer ml-1 dark:text-white/80" aria-hidden="true"></i></span>
                            </th>
                            <th wire:click="sortBy('role_id')" :direction="$sortField === 'role' ? $sortDirection : null" 
                                ...
                                Role<span><i class="fas fa-sort cursor-pointer ml-1 dark:text-white/80" aria-hidden="true"></i></span>
                            </th>
                                ...
                                <div class="flex px-4 py-1">
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <img src="/storage/{{($user->picture)}}" alt="avatar"
                                            class="inline-flex items-center justify-center mr-4 text-white transition-all duration-200 ease-soft-in-out text-size-sm w-14 rounded-xl"
                                            alt="user{{ $user->id }}" />
                            ...
                            <td
                                ...
                                <p class="mb-0 font-semibold leading-tight text-base">
                                    @can('manage-users', auth()->user())
                                        @can('update', $user)
                                            <a rel="tooltip" href="{{ route('edit-user', $user) }}">
