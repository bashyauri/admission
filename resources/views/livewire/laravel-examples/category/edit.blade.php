<div class="w-full max-w-full px-3 lg:flex-0 shrink-0">
  <div
    ...
    <div class="pt-6 pl-6 pr-6 mb-0 rounded-t-2xl">
      <h5 class="dark:text-white">Edit Category</h5>
      <p class="dark:text-white">Update category details</p>
        ...
        <div class="max-w-full px-3 flex items-center justify-center">
          ...
          <div class="flex flex-wrap mt-4 -mx-3">
            <div class="w-full max-w-full px-3 flex-0">
              <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Category Name</label>
              <input wire:model.lazy="category.name" type="text" placeholder="Enter name"
            ...
            <div class="w-full max-w-full px-3 mt-4 flex-0">
              <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Category
                Description</label>
              <textarea wire:model.lazy="category.description" rows="5" placeholder="Category description"
