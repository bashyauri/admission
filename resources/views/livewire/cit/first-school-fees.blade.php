    ...
    <div class="w-full max-w-full px-3 flex-0">
        <div
            ...
            <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                <div class="lg:flex">
                    <div>
                        <h5 class="mb-0 dark:text-white">Fresher School Fees</h5>
            ...
            <div class="flex-auto p-6 px-0 pb-0">
                <div class="overflow-x-auto table-responsive">
                    <table class="table" datatable id="products-list">
                        ...
                        <tbody>
                            @foreach ( $schoolFees as $applicant)
                            ...
                            <tr>
                                <td>
                                 ...
                                 <td class="leading-normal text-size-sm">{{$applicant->RRR}}</td>

                                <td class="leading-normal text-size-sm">{{$applicant->resource}}</td>
  ...
  {{ $applicant->status === $approved->toString() ? 'success' : 'pending' }}
                                ...
                                <td class="leading-normal text-size-sm">
                                    ...
                                    @else
                                     ...
                                     <a href="{{ route('admin.payment.status', $applicant->RRR)}}" class="py-1.8-em px-3-em bg-fuchsia-500 text-size-xxs-em rounded-1 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
