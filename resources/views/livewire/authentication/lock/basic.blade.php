<main class="mt-0 transition-all duration-200 ease-soft-in-out">
    <div
        class="pb-56 pt-12 m-4 min-h-50-screen items-start rounded-xl p-0 relative overflow-hidden flex bg-cover bg-center bg-[url('../../assets/img/curved-images/curved8.jpg')]">
    ...
    <div class="container">
        <div class="flex flex-wrap justify-center -mx-3 -mt-48 lg:-mt-48 md:-mt-56">
            <div class="w-full max-w-full px-3 mx-auto shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                <div
                    class="relative flex flex-col min-w-0 break-words bg-white border-0 lg:py-4 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-6 text-center">
                        <div class="mb-6">
                            <img class="inline-flex items-center justify-center text-white transition-all duration-200 text-size-base rounded-xl ease-soft-in-out w-28 h-28"
                                src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/team-4.jpg"
                                alt="Avatar image">
                        </div>
                        <h4 class="mb-0 font-bold">Mike Priesler</h4>
                        <p class="mb-6">Enter password to unlock your account.</p>
                        <form role="form">
                            <div class="mb-4">
