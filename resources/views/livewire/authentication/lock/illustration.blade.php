            ...
            <div class="container z-1">
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div
                        ...
                        <div
                            class="relative flex flex-col justify-center h-full px-24 m-4 bg-gradient-dark-gray rounded-xl">
                            ...
                            <div class="relative">
                                <img class="relative w-full max-w-125 z-2"
                                    src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/illustrations/dark-lock-ill.png"
                                    alt="chart-ill">
                            </div>
