<main class="mt-0 transition-all duration-200 ease-soft-in-out">
  <div>
    <section class="flex items-center min-h-screen">
      <div class="container">
        <div class="flex flex-wrap mt-32 -mx-3 lg:mt-0">
          <div class="w-full max-w-full px-3 my-auto shrink-0 lg:flex-0 lg:w-5/12 ">
            <h1
              class="animate-fade-up leading-tighter text-['calc(1.625rem_+_4.5vw)'] font-bold text-transparent bg-clip-text bg-gradient-orange z-1 relative xl:text-size-8xl">
              Error 500</h1>
          ...
          <div class="relative w-full max-w-full px-3 my-auto shrink-0 lg:flex-0 lg:w-7/12">
            <img class="relative w-full animate-fade-up"
              src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/illustrations/error-500.png"
              alt="error-404-img">
          </div>
        </div>
      </div>
