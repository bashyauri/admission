                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex-auto p-6">
                                <form role="form">
                                    <label
                                        class="inline-block mb-2 ml-1 font-bold text-slate-700 text-size-xs">Name</label>
                                    <div class="mb-4">
                            ...
                            <div
                                ...
                                <p class="mx-auto mb-4">Already have an account? <a href="{{ route('basic-sign-in') }}"
                                        class="font-bold text-transparent bg-clip-text bg-gradient-fuchsia">Sign in</a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="relative">
                                <img class="relative w-full max-w-125 z-2"
                                    src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/illustrations/rocket-white.png"
                                    alt="rocket">
                            </div>
