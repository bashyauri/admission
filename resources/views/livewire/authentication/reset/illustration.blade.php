                            ...
                            <div class="flex-auto p-6">
                                <form role="form">
                                    ...
                                    <div class="text-center">
                                        <button type="button"
                                            class="w-full inline-block px-16 py-3.5 mb-0 mt-0 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs bg-gradient-fuchsia leading-pro text-size-sm ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="relative">
                                <img class="relative w-full max-w-125 z-2"
                                    src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/illustrations/lock.png"
                                    alt="chart-ill">
                            </div>
