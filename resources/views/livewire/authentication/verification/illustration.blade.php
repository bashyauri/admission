        ...
        <div class="relative flex items-center min-h-screen p-0 overflow-hidden bg-center bg-cover">
            <div class="container z-1">
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div
                        class="flex flex-col w-full max-w-full px-3 mx-auto shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12 lg:mx-0">
                    ...
                    <div
                        ...
                        <div
                            class="relative flex flex-col justify-center h-full px-24 m-4 bg-gradient-orange rounded-xl">
                            ...
                            <div class="relative">
                                <img class="relative w-full max-w-125 z-2"
                                    src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/illustrations/danger-chat-ill.png"
                                    alt="chart-ill">
                            </div>
