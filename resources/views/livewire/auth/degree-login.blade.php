                    ...
                    <div class="flex-auto p-6 text-center">
                        ...
                        <form wire:submit.prevent="login" role="form text-left">
                            ...
                            <div class="mb-4" x-data="{ showPassword: false }">
                                <div class="relative">
                                    <input wire:model.lazy="password" :type="showPassword ? 'text' : 'password'"
                                        class="text-size-sm focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pl-3 pr-16 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="inline-block w-full px-6 py-3 mt-6 mb-2 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer bg-lime-500 active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-size-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:bg-lime-500 hover:text-white">Sign
                                    in</button>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="{{ route('degree-register') }}"
                                    class="inline-block w-full px-6 py-3 mt-6 mb-2 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer bg-lime-800 active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-size-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-dark-cyan hover:bg-lime-800 hover:text-white">Sign
                                    up</a>
                                <p class="mx-auto mb-6 leading-normal text-size-sm">
                                    Forgot your password? Reset your password
                                    <a href="{{ route('forgot-password') }}"
                                        class="relative z-10 font-semibold text-transparent bg-gradient-lime bg-clip-text">here</a>.
                                </p>
                            </div>
                        </form>
                    </div>
