<div>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 xl:w-1/4 sm:flex-none xl:mb-0">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans font-semibold leading-normal uppercase text-size-sm">Active HODs</p>
                                <h5 class="mb-0 font-bold">{{ $activeHodCount }}</h5>
                            </div>
                        </div>
                        <div class="max-w-full px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-slate-800 shadow-soft-2xl flex items-center justify-center">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="mb-0 text-sm leading-normal text-slate-500">
                                Assign multi-role capabilities (e.g. HOD, Exam Officer, Lecturer, Coordinator) to academic staff without altering their primary account.
                            </p>
                        </div>
                        <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            @if($cap->capability === 'hod')
                                                <span class="px-3.6 text-xs rounded-1.8 py-2.2 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white bg-slate-800">
                                                    HOD
                                                </span>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                            <label class="relative flex items-center p-3 border rounded-xl cursor-pointer hover:bg-slate-50 {{ $capability === 'hod' ? 'border-slate-800 bg-slate-100' : 'border-gray-200' }}">
                                <input type="radio" wire:model="capability" value="hod" class="mr-3 text-slate-800 focus:ring-slate-700" />
                                <div>
                                    <span class="block text-sm font-semibold text-slate-700">HOD</span>
                                    <span class="block text-xxs text-slate-500">Head of Dept / Endorse results</span>
                                </div>
                            </label>
                        ...
                        @if($capability === 'hod')
                            <p class="mt-2 text-xxs text-slate-600 font-medium">Select the Department Scope below to sync this user as the Head of Department for that department.</p>
