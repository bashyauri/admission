<div class="max-w-lg p-6 mx-auto bg-white rounded-md shadow-md">
    ...
    <form wire:submit.prevent="search" class="relative space-y-4" x-data="{ isDisabled: true }" x-init="$watch('jambNumber', value => isDisabled = !value.trim())">
        <!-- Input Field -->
        <div>
        ...
        <!-- Loader -->
        <div wire:loading wire:target="search" class="absolute inset-0 flex items-center justify-center bg-white bg-opacity-75">
