...
<div>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        {{ucwords($subject->subject_name)}}
                                                         <p class="mb-0 text-xs leading-tight text-slate-400">{{ucwords($subject->exam_name)}}</p>
                                                    </td>
                                                    <td
                                                        class="p-2 pl-6 border-b whitespace-nowrap dark:border-white/40 dark:text-white/60">
                                                        {{strtoupper($subject->grade)}}</td>
    ...
    <div class="w-full px-3 md:w-6/12">
        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
            <thead class="align-bottom">
                <tr>
                    <th class="px-3 py-3 text-sm leading-normal">Qualification</th>
                ...
                @empty
                    <tr>
                        <td colspan="2" class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <p class="mb-0 text-xs font-semibold leading-tight">No Record(s)</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="w-full px-3 md:w-4/12">
        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" for="department">Remark</label>
        <div class="relative flex flex-wrap items-stretch w-full rounded-lg">
            <select wire:model="remark" class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
