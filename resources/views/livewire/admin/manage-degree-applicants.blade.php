        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                <div class="lg:flex justify-between items-center">
                    <div>
                        <h5 class="mb-0 dark:text-white">Manage Degree Applicants</h5>
                        <p class="text-sm text-gray-600 mt-1">
                            Degree applicants by academic session (Role: Applicant, Programme: Degree)
                        </p>
                        <p class="text-xs text-red-600 mt-1">
                            Only applicants in the selected academic session can be exported or deleted.
                        </p>
                        <div class="mt-2">
            ...
            <div class="p-6 pb-0">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="min-w-[220px]">
                        ...
                        <select
                            wire:model.live="selectedAcademicSession"
            ...
            <div class="flex-auto p-6 px-0 pb-0">
                <div class="overflow-x-auto table-responsive">
                    <table class="table" id="degree-applicants-table">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-8 text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-sm">No degree applicants with "applicant" role found for the selected academic session.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
