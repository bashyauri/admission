                ...
                <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                    <form wire:submit="store" enctype="multipart/form-data" class="relative mb-32">
                        ...
                        {{-- <div form="account"
                            ...
                            <div class="flex flex-wrap -mx-3 text-center">
                                <div class="w-10/12 max-w-full px-3 mx-auto flex-0">
                                    <h5 class="font-normal dark:text-white">What are you doing? (checkboxes)
                                    </h5>
                                ...
                                <div class="flex flex-wrap mt-6 -mx-3">
                                    <div class="w-full max-w-full px-3 ml-auto sm:flex-0 sm:w-3/12 shrink-0">
                                        ...
                                        <label checkbox-color-label for="design"
                                            class="inline-block px-16 py-12 mb-4 ml-1 font-bold text-center uppercase align-middle transition-all bg-transparent border-2 border-solid rounded-lg shadow-none cursor-pointer group peer-checked:bg-slate-400 hover:scale-102 leading-pro text-size-xs ease-soft-in tracking-tight-soft active:opacity-85 active:shadow-soft-xs border-slate-400 text-slate-400 hover:border-slate-400 hover:bg-transparent hover:opacity-75 active:border-slate-400 active:bg-slate-400 active:text-white">
                                            <svg class="text-slate-700" width="20px" height="20px" viewBox="0 0 40 40"
                                                    ...
                                                    <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF"
                                                        ...
                                                        <g transform="translate(1716.000000, 291.000000)">
                                                            <g transform="translate(304.000000, 151.000000)">
                                                                <polygon checkbox-color class="fill-slate-800"
                                                                    opacity="0.596981957"
                                    ...
                                    <div class="w-full max-w-full px-3 sm:flex-0 sm:w-3/12 shrink-0">
                                        ...
                                        <label checkbox-color-label for="code"
                                            class="inline-block px-16 py-12 mb-4 ml-1 font-bold text-center uppercase align-middle transition-all bg-transparent border-2 border-solid rounded-lg shadow-none cursor-pointer group peer-checked:bg-slate-400 hover:scale-102 leading-pro text-size-xs ease-soft-in tracking-tight-soft active:opacity-85 active:shadow-soft-xs border-slate-400 text-slate-400 hover:border-slate-400 hover:bg-transparent hover:opacity-75 active:border-slate-400 active:bg-slate-400 active:text-white">
                                            <svg class="text-slate-700" width="20px" height="20px" viewBox="0 0 42 42"
                                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <div class="w-full max-w-full px-3 mr-auto sm:flex-0 sm:w-3/12 shrink-0">
                                        <input id="develop" type="checkbox"
                                            class="absolute pointer-events-none peer clip-rect-0">
                            ...
                            <div>
                                <div class="flex flex-wrap -mx-3 text-left">
                                    ...
                                    <div class="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-6/12">
                                        ...
                                        <input type="text" wire:model="corAddress"
                                            class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-8/12">
                                        ...
                                        <input type="text" wire:model="kinAddress" placeholder="Eg. Soft"
                                            class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-4/12">
                                        ...
                                        <input type="text" wire:model="kinName"  placeholder="Eg 221"
                                            class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-7/12">
                                        ...
                                        <input type="text" wire:model="state" placeholder="Eg Tokyo"
                                            class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    ...
                                    <div class="w-full max-w-full px-3 mt-6 text-left flex-0 sm:w-4/12 sm:mt-0">
                                        <label
                                            class="mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80"
                                            for="City">City</label>
                                        <input type="text" wire:model="lga" placeholder="Eg Tokyo"
                                            class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                </div>
                                <div class="flex flex-wrap -mx-3">
