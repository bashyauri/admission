<div  wire:key="{{$school->id}}"  class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-dark-gray">
    <div class="flex justify-between space-x-2">
        <div class="flex items-center">
           ...
           @else
            ...
            <h3 class="text-lg text-semibold text-gray-800">{{$school->school_name}}</h3>
            @endif
