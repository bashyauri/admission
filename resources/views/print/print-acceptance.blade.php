...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('assets/css/print-acceptance.css') }}" media="print">
...
<body>
    <div class="offer">
        <div class="heading">
            ...
            <div class="heading">
                <h2 class="">DIRECTORATE OF HIGHER STUDIES </h2>
                <h3 class="">WAZIRI UMARU FEDERAL POLYTECHNIC </h3>
                <h3>BIRNIN KEBBI</h3>
        ...
        <div class="address-div">
            <div class="to-div">
                ...
                To: <strong>.......{{ strtoupper(auth()->user()->full_name) }}.....</strong>
