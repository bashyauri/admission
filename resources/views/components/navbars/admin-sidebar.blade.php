    ...
    <aside mini="false"
        ...
        <li class="mt-0.5 w-full">
            ...
            after:transition-all after:duration-200 after:content-['\f107'] dark:text-white dark:opacity-80">
                ...
                <span
                    class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{ in_array_r(request()->route()->getName(),getCategoriesArray('applications')) ? 'text-slate-700' : '' }}">Settings</span>
            </a>
        ...
        <li class="w-full mt-4">
            <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-size-xs opacity-60 dark:text-white">ADMISSION
            </h6>
        </li>
                ...
                <ul class="flex flex-wrap pl-4 mb-0 ml-6 list-none transition-all duration-200 ease-soft-in-out">
                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'hod.all-applicants' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                            href="{{ route('admin.upload-applicants') }}">
                            <span
                                class="w-0 text-center transition-all duration-200 opacity-0 pointer-events-none ease-soft-in-out">
                                K
                            </span>
                            <span class="transition-all duration-100 pointer-events-none ease-soft">Upload Jamb Applicants </span>
                        </a>
                    </li>
                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'hod.all-applicants' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                    ...
                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'olevel' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                            ...
                            <span class="transition-all duration-100 pointer-events-none ease-soft"> Shortlisted </span>
                        </a>
                    </li>
                    ...
                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'admin.manage-degree-applicants' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                            href="{{ route('admin.manage-degree-applicants') }}">
                            <span
                                class="w-0 text-center transition-all duration-200 opacity-0 pointer-events-none ease-soft-in-out">
                                D
                            </span>
                            <span class="transition-all duration-100 pointer-events-none ease-soft text-red-600">
                                Manage Degree Applicants
                            </span>
                        </a>
                    </li>

                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'admin.manage-postgraduate-applicants' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                            href="{{ route('admin.manage-postgraduate-applicants') }}">
                            <span
                                class="w-0 text-center transition-all duration-200 opacity-0 pointer-events-none ease-soft-in-out">
                                P
                            </span>
                            <span class="transition-all duration-100 pointer-events-none ease-soft text-red-600">
                                Manage PG Applicants
                            </span>
                        </a>
                    </li>

                    <li class="w-full">
                        <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-size-sm relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 shadow-none transition-colors before:absolute before:top-1/2 before:-translate-y-1/2 before:rounded-3xl before:content-[''] dark:text-white dark:before:bg-white dark:before:opacity-80 {{ Route::currentRouteName() == 'admin.fubk' ? 'before:-left-5 rounded-lg font-semibold text-slate-800 before:h-2 before:w-2 before:bg-slate-800 dark:opacity-100' : 'before:-left-4.5 before:h-1.25 before:w-1.25 font-medium text-slate-800/50 before:bg-slate-800/50 dark:opacity-60' }}"
                            href="{{ route('admin.fubk') }}">
                            <span
                                class="w-0 text-center transition-all duration-200 opacity-0 pointer-events-none ease-soft-in-out">
                                F
                            </span>
                            <span class="transition-all duration-100 pointer-events-none ease-soft text-cyan-700 dark:text-cyan-300">
                                FUBK
                            </span>
                        </a>
                    </li>
        ...
        <div class="h-auto overflow-hidden transition-all duration-200 ease-soft-in-out max-h-0" id="ecommerceExamples">
            <ul class="flex flex-wrap pl-4 mb-0 ml-6 list-none transition-all duration-200 ease-soft-in-out">
                ...
                <li class="w-full">
                  ...
                  'active_secondary
                  aria-expanded=true' :
                  'aria-expanded=false' }} collapse_trigger="secondary" href="javascript:;" class="after:ease-soft-in-out
                            ...
                            <li class="w-full">
                                <a {{ Route::currentRouteName()=='edit-product' ? 'active_page' : '' }}
                                    ...
                                    <span
                                        class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                        E </span>
                                    <span class="transition-all duration-100 pointer-events-none ease-soft"> Edit
                                        Product </span>
                                </a>
                            </li>
                            ...
                            <li class="w-full">
                                <a {{ Route::currentRouteName()=='product-page' ? 'active_page' : '' }}
                                    ...
                                    <span
                                        class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                        P </span>
                                    <span class="transition-all duration-100 pointer-events-none ease-soft"> Product
                                        Page </span>
                                </a>
                            </li>
                            ...
                            <li class="w-full">
                                <a {{ Route::currentRouteName()=='products-list' ? 'active_page' : '' }}
                                    ...
                                    <span
                                        class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                        P </span>
                                    <span class="transition-all duration-100 pointer-events-none ease-soft"> Products
                                        List </span>
                                </a>
                            </li>
                            ...
                            <li class="w-full">
                                <a {{ Route::currentRouteName()=='order-details' ? 'active_page' : '' }}
                                    ...
                                    <span
                                        class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                        O </span>
                                    <span class="transition-all duration-100 pointer-events-none ease-soft"> Order
                                        Details </span>
                                </a>
                            </li>
                ...
                <ul class="flex flex-wrap pl-4 mb-0 ml-6 list-none transition-all duration-200 ease-soft-in-out">
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            B </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Basic
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            C </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Cover
                                        </span>
                                    </a>
                                </li>
                    ...
                    <li class="w-full">
                        <a collapse_trigger="secondary"
                            ...
                            <span class="transition-all duration-100 pointer-events-none ease-soft"> 2-Step Verification
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            E </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Error
                                            404 </span>
                                    </a>
                                </li>
        ...
        <li class="mt-0.5 w-full">
            ...
            <h6 class="pl-6 mb-2 ml-2 font-bold leading-tight uppercase text-size-xs opacity-60 dark:text-white">DOCS
            </h6>
        </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            Q </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Quick
                                            Start </span>
                                    </a>
                                </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            L </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> License
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            B </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Build
                                            Tools </span>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            C </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Colors
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            G </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Grid
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="w-full">
                                    <a class="ease-soft-in-out py-1.6 ml-5.4 pl-4 text-3.4 relative my-0 mr-4 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
                                        ...
                                        <span
                                            class="w-0 leading-tight text-center transition-all duration-200 opacity-0 pointer-events-none text-size-xs ease-soft-in-out">
                                            I </span>
                                        <span class="transition-all duration-100 pointer-events-none ease-soft"> Icons
                                        </span>
                                    </a>
                                </li>
                            </ul>
