...
class Edit extends Component
{
    ...
    protected function rules()
    {
        ...
        return [
            'item.name' => 'required|min:3|unique:items,name,' . $this->item->id,
    ...
    public function update()
    {
        ...
        if ($this->picture) {
            ...
            if ($currentPicture !== 'pictures/home-decor-1.jpg' && $currentPicture !== 'pictures/home-decor-2.jpg' && $currentPicture !== 'home-decor-3.jpg') {
