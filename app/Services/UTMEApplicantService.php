    ...
    public function getUtmeFirstSchoolFeesPayment(): Collection
    {
        return StudentTransaction::select('student_transactions.*', 'users.surname', 'users.firstname', 'users.m_name', 'users.jamb_no', 'users.phone')
            ...
            ->where([
                ...
                'users.role' => Role::APPLICANT,

            ])->get();
    }
    public function generateUgRegistrationNumber($year, $modeOfEntry, $facultyCode = "09", $departmentCode): string
    {
        ...
        $lastRegNumber = DB::table('academic_details')
            ...
            ->whereYear('created_at', $fullYear) // Use full year here
        ...
        $newIncrement = str_pad((string)($lastIncrement + 1), 3, '0', STR_PAD_LEFT);
