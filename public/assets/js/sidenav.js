...
const laravelExamples = ["new-user-management", "new-role-management", "new-category", "new-tag", "new-item"];

// && isNaN(current_page)) - fix for dyanmic pages
if (root_page != "" && isNaN(current_page)) {

  var a_href = origin + "/" + root_page + "/" + parent_page + "/" + current_page;
  ...
  // fix for dynamic pages
  if (!isNaN(current_page)) {
    var a_href = origin + "/" + root_page + "/" + parent_page;
  } else {
    // fix for laravel examples - create pages
    if (laravelExamples.includes(current_page)) {
      var a_href = origin + "/" + parent_page + "/" + "user-profile";
    } else {
      var a_href = origin + "/" + parent_page + "/" + current_page;
    }
  }
